      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 w-full">
        <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <button
                onClick={openLeadBot}
                className="group inline-flex items-center justify-center rounded-full bg-red-600 px-8 py-4 text-base font-semibold text-white transition-all hover:bg-red-700 hover:shadow-xl hover:shadow-red-200"
              >
