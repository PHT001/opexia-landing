        ...
        <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <button
                ...
                className="group inline-flex items-center justify-center rounded-full bg-[#007AFF] px-8 py-4 text-base font-semibold text-white transition-all hover:bg-[#0055D4] hover:shadow-xl hover:shadow-blue-200 focus-visible:ring-2 focus-visible:ring-[#007AFF] focus-visible:ring-offset-2"
              >
